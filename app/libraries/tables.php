...
class tables {
    ...
    function __construct(){
        ...
        $this->tb['t_sales_target'] = 't_sales_target';
        
        $this->tb['g_m_gift_voucher'] = 'g_m_gift_voucher';
        $this->tb['g_t_grn_sum'] = 'g_t_grn_sum';
        $this->tb['g_t_sales_sum'] = 'g_t_sales_sum';
        ...
        $this->tb['t_cheque_received'] = 't_cheque_received';
        ...
        $this->tb['t_internal_trans_voucher_sum']='t_internal_trans_voucher_sum';
        $this->tb['t_branch_settlement']='t_branch_settlement';
        $this->tb['t_advance_sum_branch'] = 't_advance_sum_branch';
