    ...
    //----------------------------------------------------------------------------------------------------
			...
			if(($cluster1!="0") && ($branch1!="0"))
			{
				   ...
				   $this->pdf->Ln();
		            ...
		            $this->pdf->Cell(22, 6,"Cheque No", '1', 0, 'C', 0);
		            $this->pdf->Cell(22, 6,"Cash", '1', 0, 'C', 0);
				    $this->pdf->Cell(22, 6,"Cheque", '1', 0, 'C', 0);
		            $this->pdf->Cell(22, 6,"C.Card", '1', 0, 'C', 0);
		            $this->pdf->Cell(22, 6,"D.Note", '1', 0, 'C', 0);
					...
					foreach ($sum as $value) {	
			            ...
			            $this->pdf->MultiCell(22, $heigh, $value->chq_no, 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
			            $this->pdf->MultiCell(22, $heigh, number_format($value->pay_cash,2), 1, 'R', 0, 0, '', '', true, 0, false, true, 0);
			            $this->pdf->MultiCell(22, $heigh, number_format($value->pay_issue_chq,2), 1, 'R', 0, 0, '', '', true, 0, false, true, 0);
			            $this->pdf->MultiCell(22, $heigh, number_format($value->pay_credit,2), 1, 'R', 0, 0, '', '', true, 0, false, true, 0);
			            $this->pdf->MultiCell(22, $heigh, number_format($value->pay_dnote,2), 1, 'R', 0, 0, '', '', true, 0, false, true, 0);
			            $this->pdf->MultiCell(22, $heigh, number_format($value->discount,2), 1, 'R', 0, 0, '', '', true, 0, false, true, 0);
		            ...
		            $this->pdf->Cell(22, 6, number_format($cash,2), '1', 0, 'R', 0);
					$this->pdf->Cell(22, 6, number_format($cheque,2),'1', 0, 'R', 0);
		            $this->pdf->Cell(22, 6, number_format($credit,2), '1', 0, 'R', 0);
		            $this->pdf->Cell(22, 6, number_format($dnote,2), '1', 0, 'R', 0);
		            $this->pdf->Cell(22, 6, number_format($discount,2), '1', 0, 'R', 0);
		           ...
		           if(count($cancled)>0){       
		            ...
		            if($x==0)
		            {
			            ...
			            $this->pdf->Cell(22, 6,"Debit Note", '1', 0, 'C', 0);
			            $this->pdf->Cell(22, 6,"Discount", '1', 0, 'C', 0);
			            $this->pdf->Cell(30, 6,"Total Settlement", '1', 0, 'C', 0);
			            $this->pdf->Ln();
			        }
