...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= base_url(); ?>css/themify-icons/themify-icons.css" />	
	...
	<script type="text/javascript" src="<?=base_url(); ?>js/main.js?<?= rand() ?>"></script>
...
<body ondragstart="return false;" ondrop="return false;" >
	...
	<div id="serch_pop4" style="width: 800px;">
		...
		<form id="print_pdff" action="<?php echo site_url(); ?>/reports/generate" method="post" target="_blank" style='display:none;'>
			<input type='hidden' name='by' value='r_stock_in_hand_batch' id="r_stock_in_hand_batch" class="report"/>
		</form>
	...
	<div id="serch_pop6" style="width: 800px;">
	    <input type="text" id="pop_search6" title=""  style="width: 100%;" /><br />
	    <div id="sr6" style="height:400px;"></div>
	    <div style="text-align: right; padding-top: 7px;">
	    <input type='button' value='Approve' title='Approve' id='approve4' style='display:none;'/>
	    <button id="pop_close6" >Close</button></div>
	</div> -->
		...
		<div class="logout" >
			<div class="logout_block" >
				<div class="logout_block_center">
					...
					<img alt='Promotions Search' id='itmPromo' style='cursor:pointer;width:30px; height:30px; margin-top:2px; margin-left:-150px; position:absolute;>' src="<?=base_url(); ?>/images/gift.png"/>
					<img alt='Hold Bill' id='holdBill' style='cursor:pointer;width:30px; height:30px; margin-top:2px; margin-left:-110px; position:absolute;>' src="<?=base_url(); ?>/images/hold_bill.png"/>
					
					
						<img id='pending_chq' style='cursor:pointer;width:30px; height:30px; margin-top:2px; margin-left:-71px; position:absolute;>' src="<?=base_url(); ?>/images/mail_warning.png"/>
...
<div id="det_box3">
	<img id="close_det_box" src="<?=base_url(); ?>/images/close_button.png"/>
	<div id="det_box3_inner"><?php if(isset($det_box3)){ echo $det_box3;} ?></div>
</div>
		...
		<div id='Main_Menu' >
				...
				<li class="current"><a  href="#a"><img src="<?=base_url()?>images/arrow.png"  /></a>
					<ul style="width:63px;">
								...
								<ul>
									...
									{ 
										...
										<li><a href="#" class="parent"><span>Item</span></a>
											<ul>
												...
												<hr class="hline"/>
												<?php if($this->user_permissions->is_view('m_item_commission')){ ?><li><a  href="?action=m_item_commission">Item Commission Setup</a></li><?php } ?>
												<?php if($this->user_permissions->is_view('m_item_promotions')){ ?><li><a  href="?action=m_item_promotions">Item Promotions Setup</a></li><?php } ?>
												<hr class="hline"/>
												<?php if($this->user_permissions->is_view('t_price_change_sum')){ ?><li><a  href="?action=t_price_change_sum">Price Change</a></li><?php } ?>
												...
												<?php if($this->user_permissions->is_view('return_reason')){ ?><li><a  href="?action=return_reason">Reason Setup</a></li><?php } ?>
											</ul>
									...
									{ 
										...
										<li><a href="#" class="parent"><span>Customer</span></a>
											<ul>
												...
												<?php if($this->user_permissions->is_view('r_root')){ ?><li><a  href="?action=r_root">Root</a></li><?php } ?>
									...
									{ 
										...
										<li><a href="#" class="parent"><span>Account</span></a>
											<ul>
												<?php if($this->user_permissions->is_view('m_account_category')){ if(false){?><li><a  href="?action=m_account_category">Account Category</a></li><?php } } ?>
												...
												<?php if($this->user_permissions->is_view('m_account')){ if(false){ ?><li><a  href="?action=m_account">Account Setup</a></li><?php } }?>
												...
												<?php if($this->user_permissions->is_view('m_allocate_bank_branch')){ ?><li><a  href="?action=m_allocate_bank_branch">Bank Allocate To Branch</a></li><?php } ?>
											</ul>
										</li>
									<?php } ?>
									<?php 
									if(  $this->user_permissions->is_view('r_sales_category')||
										$this->user_permissions->is_view('r_groups'))
									{ 
									...
									<?php } ?>
									<?php 
									if(  $this->user_permissions->is_view('m_employee_category')||
										$this->user_permissions->is_view('m_employee_activity')||
										$this->user_permissions->is_view('m_employee_details'))
									{ 
									...
									<?php } ?>
									<?php 
									if(  $this->user_permissions->is_view('m_vehicle_setup'))
									{ 
						...
						if($this->user_permissions->is_view('r_groups')||
							...
							$this->user_permissions->is_view('t_internal_transfer_return')||
							$this->user_permissions->is_view('t_internal_transfer_receive')||
							$this->user_permissions->is_view('t_dispatch_sum')||
							$this->user_permissions->is_view('t_internal_trans_receipt')||
							...
							$this->user_permissions->is_view('t_cheques_rtn_payment')||
									...
									{ 
										...
										<li><a href="#" class="parent"><span>Sales</span></a>
											<ul>
												...
												<?php if($this->user_permissions->is_view('r_group_sales_budget')){ ?><li><a  href="../../seetha_pos" target="_blank">POS</a></li><?php } ?>
												...
												<?php if($this->user_permissions->is_view('t_advance_payment')){ ?><li><a  href="?action=t_advance_payment">Advance Receipt</a></li><?php } ?>
									...
									{ 
										...
										<li><a href="#" class="parent"><span>Stock</span></a>
											<ul>
												...
												<?php if($this->user_permissions->is_view('t_internal_trans_receipt')){ ?><li><a  href="?action=t_internal_trans_receipt">Internal Transfer Receipt</a></li><?php } ?>
												<?php if($this->user_permissions->is_view('t_internal_trans_voucher')){ ?><li><a  href="?action=t_internal_trans_voucher">Internal Transfer Voucher</a></li><?php } ?>
												<hr class="hline"/>
												<?php if($this->user_permissions->is_view('t_advance_payment_branch')){ ?><li><a  href="?action=t_advance_payment_branch">Branch Advance Payment</a></li><?php } ?>
												<?php if($this->user_permissions->is_view('t_branch_settlement')){ ?><li><a  href="?action=t_branch_settlement">Branch Settlement</a></li><?php } ?>
												<hr class="hline"/>
               	...
               	<!-- <li><a href="#" class="parent"><span>Salesman</span></a>
                    <ul>
                        <?php if($this->user_permissions->is_view('m_employee')){ ?><li><a  href="?action=m_employee">Employee</a></li><?php } ?>
                        <?php if($this->user_permissions->is_view('r_designation')){ ?><li><a  href="?action=r_designation">Employee Designation</a></li><?php } ?>
                    </ul>
                </li> -->
            <?php } ?>
            ...
            { 
            	...
            	<li><a href="#" class="parent"><span>User</span></a>
            		<ul>
            			<?php if($this->user_permissions->is_view('m_authorization')){ ?><li><a  href="?action=m_authorization">User Authorization Levels</a></li><?php } ?>
            			<?php if($this->user_permissions->is_view('t_authorization_update')){ ?><li><a  href="?action=t_authorization_update">User Authorization</a></li><?php } ?>
            		</ul>
            	</li>
            <?php } ?>
...
<?php  
if($this->user_permissions->is_view('m_gift_voucher')||
	$this->user_permissions->is_view('t_grn_sum_gift')||
	$this->user_permissions->is_view('g_t_pur_ret_sum')||
	$this->user_permissions->is_view('g_t_sales_sum')||
	$this->user_permissions->is_view('g_internel_transfer_order')||
	$this->user_permissions->is_view('g_internel_transfer')||
	$this->user_permissions->is_view('g_internel_transfer_receive')){
		?>
		<li>
			<a href="#"><img src="<?php echo base_url(); ?>images/gift.png" alt="" width="53" height="43" /></a>
			<ul>
				<?php if($this->user_permissions->is_view('m_gift_voucher')){ ?><li><a  href="?action=m_gift_voucher">Gift Voucher</a></li><?php } ?>
				<?php if($this->user_permissions->is_view('t_grn_sum_gift')){ ?><li><a  href="?action=t_grn_sum_gift">Gift Voucher Purchase</a></li><?php } ?>
				<?php if($this->user_permissions->is_view('g_t_pur_ret_sum')){ ?><li><a  href="?action=g_t_pur_ret_sum">Gift Voucher Purchase Return</a></li><?php } ?>
				<?php if($this->user_permissions->is_view('g_t_sales_sum')){ ?><li><a  href="?action=g_t_sales_sum">Gift Voucher Sales</a></li><?php } ?>
				<?php if($this->user_permissions->is_view('g_internel_transfer_order')){ ?><li><a  href="?action=g_internel_transfer_order">Gift Voucher Transfer Order</a></li><?php } ?>
				<?php if($this->user_permissions->is_view('g_internel_transfer')){ ?><li><a  href="?action=g_internel_transfer">Gift Voucher Internel Transfer</a></li><?php } ?>
				<?php if($this->user_permissions->is_view('g_internel_transfer_receive')){ ?><li><a  href="?action=g_internel_transfer_receive">Gift Voucher Transfer Receive</a></li><?php } ?>
			</ul>
		</li>
	<?php } ?>
	...
	{ 
			...
			<ul>
					...
					<li><a  class="parent"><span>Bank</span></a>
						<ul>
							...
							<li><a  href="?action=f_chq_find"><span>Cheque Find</span></a></li>
						</ul>
					</li>

					<?php if($this->user_permissions->is_view('t_sales_target')){ ?>
						<li><a  class="parent"><span>Sales Target</span></a>
							<ul>
								<li><a  href="?action=t_sales_target"><span>Sales Target </span></a></li>
								<li><a  href="?action=r_sales_target_report"><span>Sales Target Report </span></a></li>
							</ul>
						</li>
					<?php } ?>
					<?php 
					...
					{ 
						...
						<?php if($this->user_permissions->is_view('r_sales_reports')){ ?><li><a  href="?action=r_sales_reports" class="parent"><span>Sales</span></a></li><?php } ?> 
					<?php } ?>	
					...
					if($this->user_permissions->is_view('r_transaction_list_purchase')||
						...
						$this->user_permissions->is_view('r_total_sale')|
						/*$this->user_permissions->is_view('r_cheque_list')||*/
						$this->user_permissions->is_view('r_transaction_list_voucher'))
					{ 
						?> 
						<li><a href="#" class="parent"><span>Transaction</span></a>
							<ul>
								...
								<!--<?php if($this->user_permissions->is_view('r_cheque_list')){ ?><li><a  href="?action=r_cheque_list">Cheque Lists</a></li><?php } ?>-->
								<?php if($this->user_permissions->is_view('r_group_sale_balance')){ ?><li><a  href="?action=r_group_sale_balance">Group Sale Balance</a></li><?php } ?>																			<!-- <li><a  href="?action=r_r">R</a></li> -->
							</ul>
						</li>
					<?php } ?> 
					...
					{ 
						...
						<li><a href="#" class="parent"><span>Summery</span></a>
							<ul>
								...
								<?php if($this->user_permissions->is_view('m_dialy_summery_reset')){ ?><li><a target="_blank" href="?action=m_dialy_summery_reset">Daily Summery Reset</a></li><?php } ?> 
							</ul>
						</li> 
					...
					<?php 
					if($this->user_permissions->is_view('r_cheque_print'))
					{ 
						?>
						<li><a href="#" class="parent"><span>Print Cheque </span></a>
							<ul>
								<?php if($this->user_permissions->is_view('r_cheque_print')){ ?><li><a target="" href="?action=r_cheque_print">Print Cheque</a></li><?php } ?> 
							</ul>
						</li> 
					...
					<?php if($this->user_permissions->is_view('r_cheque_print')){ ?>
						<?php if($this->user_permissions->is_view('r_gift_voucher_report')){ ?><li><a  href="?action=r_gift_voucher_report" class="parent"><span>Gift Voucher</span></a> </li><?php } ?>
					<?php } ?> 
		...
		if($this->user_permissions->is_view('s_company')||
			...
			$this->user_permissions->is_view('r_branch_c_acc')||
					...
					{ 
						...
						<li><a  href="#">Company</a>
							<ul>
								...
								<?php if($this->user_permissions->is_view('m_branch_supervisor')){ ?><li><a  href="?action=m_branch_supervisor">Branch Supervisor Setup</a></li><?php } ?>
							</ul>
						</li>

					<?php } ?>
					<?php if($this->user_permissions->is_view('s_users')){ ?><li><a  href="user_permission?action=s_users">User Permission</a></li><?php } ?>
                    <!-- <?php if($this->user_permissions->is_view('s_users')){ ?><li><a  href="?action=s_users">Users</a></li><?php } ?>
                    <?php if($this->user_permissions->is_view('s_module')){ ?><li><a  href="?action=s_module">Module</a></li><?php } ?>
                    <?php if($this->user_permissions->is_view('s_role')){ ?><li><a  href="?action=s_role">User Role</a></li><?php } ?>  -->
                    <?php if($this->user_permissions->is_view('r_user_list')){ ?><li><a  href="?action=r_user_list">User List</a></li><?php } ?> 
        ...
        if($this->user_permissions->is_view('f_find_item_all')||
        	...
        	$this->user_permissions->is_view('f_find_item_img')||
        	$this->user_permissions->is_view('f_find_transaction_log_det')||
        	$this->user_permissions->is_view('find_item_current_stock')||
        ...
        { 
        	...
        	<li><a href="#"><img src="<?=base_url()?>images/search.png"  width="43" height="43" /></a>
        		<ul>
        			<?php if($this->user_permissions->is_view('find_item_current_stock')){?><li><a href="?action=find_item_current_stock">Find Item Current Stock </a></li><?php }?>
        			<?php if($this->user_permissions->is_view('f_find_item_all')){ ?><li><a  href="?action=f_find_item_all">Find Item - All</a></li><?php } ?> 
        			<?php if($this->user_permissions->is_view('f_find_item_img')){ ?><li><a  href="?action=f_find_item_img">Find Item Images </a></li><?php } ?>
        			...
        			<?php if($this->user_permissions->is_view('f_find_merchant')){ ?><li><a  href="?action=f_find_merchant">Find Credit Card Merchant</a></li><?php } ?>
        ...
        {            
        	...
        	<li><a href="#"><img src="<?=base_url()?>images/chq.png"  width="48" height="48" /></a>
        		<ul>
        			<?php if($this->user_permissions->is_view('chq_print_scheme')){ ?><li><a  href="?action=chq_print_scheme">Cheque Printing Scheme</a></li><?php } ?>
        ...
        <?php
        if($this->user_permissions->is_view('t_loyalty_card_category')||
        	$this->user_permissions->is_view('t_loyalty_card_issue')||
        	$this->user_permissions->is_view('t_loyalty_card_update')||
        	$this->user_permissions->is_view('t_loyalty_card_request')||
        	$this->user_permissions->is_view('t_loyalty_card_request_approve'))
        {            
        	?>
        	<li><a href="#"><img src="<?=base_url()?>images/loyalty.png"  width="48" height="48" /></a>
        		<ul>
        			<?php if($this->user_permissions->is_view('t_loyalty_card_category')){ ?><li><a  href="?action=t_loyalty_card_category">Loyalty Card Category</a></li><?php } ?>
        			<?php if($this->user_permissions->is_view('t_loyalty_card_issue')){ ?><li><a  href="?action=t_loyalty_card_issue">Loyalty Card Issue</a></li><?php } ?>    
        			<?php if($this->user_permissions->is_view('t_loyalty_card_update')){ ?><li><a  href="?action=t_loyalty_card_update">Loyalty Card Update</a></li><?php } ?> 
        			<?php if($this->user_permissions->is_view('t_loyalty_card_request')){ ?><li><a  href="?action=t_loyalty_card_request">Loyalty Card Request</a></li><?php } ?> 
        			<?php if($this->user_permissions->is_view('t_loyalty_card_request_approve')){ ?><li><a  href="?action=t_loyalty_card_request_approve">Loyalty Card Request Approve</a></li><?php } ?> 
