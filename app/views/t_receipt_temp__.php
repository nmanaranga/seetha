            ...
            <table style="width: 100%" border="0">
                <tr>
                    ...
                    <td>
                     ...
                     <input type="text" class="hid_value" title='' readonly="readonly" id="customer" name="customer"  style="width: 300px;">
                     &nbsp;<input type="checkbox" name="curr_acc" id="curr_acc" title="1">&nbsp;Current Account
                 </td>
