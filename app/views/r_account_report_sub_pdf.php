...
$this->pdf->setPrintHeader($header,$type); 
		...
		foreach ($op as $key){
            ...
            $this->pdf->setX(10);
		 	...
		 	$this->pdf->Cell(20, 1, "No", '1', 0, 'L', 0);
		 	$this->pdf->Cell(11, 1, "Sub No", '1', 0, 'L', 0);
		 	$this->pdf->Cell(25, 1, "Transaction", '1', 0, 'C', 0);
		 	$this->pdf->Cell(50, 1, "Description", '1', 0, 'L', 0);
		 	$this->pdf->Cell(22, 1, "Dr Amount", '1', 0, 'R', 0);
		 	$this->pdf->Cell(22, 1, "Cr Amount", '1', 0, 'R', 0);
		 	$this->pdf->Cell(22, 1, "Balance", '1', 0, 'R', 0);
			...
			$this->pdf->Cell(20, 1, '', '1', 0, 'L', 0);
		 	$this->pdf->Cell(20, 1, "", '1', 0, 'L', 0);
		 	$this->pdf->Cell(11, 1, "", '1', 0, 'L', 0);
		 	$this->pdf->Cell(25, 1, "", '1', 0, 'L', 0);
		 	$this->pdf->Cell(50, 1, "Begining Balance", '1', 0, 'L', 0);
		 	$this->pdf->Cell(22, 1, number_format($dr,2), '1', 0, 'R', 0);
		 	$this->pdf->Cell(22, 1,  number_format($cr,2), '1', 0, 'R', 0);
		 	$this->pdf->Cell(22, 1,  number_format($op,2), '1', 0, 'R', 0);
		 	...
		 	foreach($all_acc_det as $row){
				...
				$this->pdf->MultiCell(11, $heigh, $sub, 1, 'R', 0, 0, '', '', true, 0, false, true, 0);
				...
				$this->pdf->MultiCell(22, $heigh, $row->dr_amount, 1, 'R', 0, 0, '', '', true, 0, false, true, 0);
				$this->pdf->MultiCell(22, $heigh, $row->cr_amount, 1, 'R', 0, 0, '', '', true, 0, false, true, 0);
				$this->pdf->MultiCell(22, $heigh,number_format($total,2, '.', ''), 1, 'R', 0, 1, '', '', true, 0, false, true, 0);
			...
			$this->pdf->Cell(20, 1, '', '1', 0, 'L', 0);
		 	...
		 	$this->pdf->Cell(11, 1, "", '1', 0, 'L', 0);
		 	$this->pdf->Cell(25, 1, "", '1', 0, 'L', 0);
		 	$this->pdf->Cell(50, 1, "Period Balance", '1', 0, 'L', 0);
		 	$this->pdf->Cell(22, 1, number_format($period_dr,2), '1', 0, 'R', 0);
		 	$this->pdf->Cell(22, 1, number_format($period_cr,2), '1', 0, 'R', 0);
		 	$this->pdf->Cell(22, 1, "", '1', 0, 'R', 0);
			...
			$this->pdf->Cell(20, 1, '', '1', 0, 'L', 0);
		 	...
		 	$this->pdf->Cell(22, 1, number_format($dr_toal,2), '1', 0, 'R', 0);
		 	$this->pdf->Cell(22, 1, number_format($cr_toal,2), '1', 0, 'R', 0);
		 	$this->pdf->Cell(22, 1, number_format($total,2), '1', 0, 'R', 0);
