...
<div class="dframe" id="mframe">
    <form method="post" action="<?=base_url()?>index.php/main/save/s_company" id="form_">
        <table style="width: 100%" border="0">
            <tr>
                <td>Company Name</td>
                <td><input type="text" class="input_active" title='<?=$name;?>' id="name" name="name"  maxlength="255" style="width:300px;"/></td>
            </tr><tr>
                <td>Address 01</td>
                ...
                <td>Email Address</td>
                <td><input type="text" class="input_active" title='<?=$email;?>' id="email" name="email" style="width:300px;"/></td>
            </tr>
        </table>
