<?php if($this->user_permissions->is_view('t_cheques')){ ?>
<style>
.sc
{
width:500px;
...
<script type='text/javascript' src='<?=base_url()?>js/t_cheques.js?<?= rand() ?>'></script>
...
<div class="dframe" id="mframe" style=" margin-top:10px; width:800px;" >
    <form method="post" action="<?=base_url()?>index.php/main/save/t_cheques" id="form_">
        <table style="width: 100%" border="0">
            <tr>
                ...
                <td>
                    <select style="width:100%;" name="type" id="type">
                        ...
                        <option value='3'>Advance Receipt</option>
            ...
            <tr>
                 <td>Returned &nbsp;&nbsp;<input type="radio" class='ref_chq' id="refu_rt" name="refund_chq" value="1" title="1"></td>
                 <td>Post Dated&nbsp;&nbsp;<input type="radio" class='ref_chq' id="refu_pd" name="refund_chq" value="2" title="2">
                    <input type="hidden" id="chq_rf_type" name="chq_rf_type" value="1"></td>
           ...
           <td colspan="1">
                ...
                <td>Debit Note&nbsp;<input type="radio" id="drn" name="refund_type" value="1" title="1"></td>
                <td>Unsettle &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" id="unsettle" name="refund_type" value="2" title="2"></td>
                <td>Date</td>
            ...
            <tr>
            	<td>Memo</td>
            	<td colspan="3"><input type="text" class="hid_value" name="memo" id="memo" style="width:422px;"/></td>
            	<td>Cash Value</td>
