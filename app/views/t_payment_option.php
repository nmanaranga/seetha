                                        ...
                                        <tbody>
                                            <?php
                                                for($x=0; $x<10; $x++){
                                                    ...
                                                    echo "<td><input type='text' class='g_input_txt chqno7'  id='chqu7_".$x."' name='chqu7_".$x."'/></td>";
                                    ...
                                    <tbody>
                                        <?php
                                            for($x=0; $x<10; $x++){
                                                ...
                                                echo "<td><input type='text' class='g_input_txt chq9' id='cheque9_".$x."' name='cheque9_".$x."'/></td>";
