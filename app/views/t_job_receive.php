        ...
        <form method="post" action="<?=base_url()?>index.php/main/save/t_job_receive" id="form_">
            <table style="width: 100%" border="0">
                ...
                <tr>
                    ...
                    <td style="width: 100px;"><input type="text" class="input_txt" name="crn" id="crn" title='<?=$crn_no?>' style="width: 100%;"/></td>
            ...
            <tr>
            	<td colspan="4">
                    <div style="text-align: left; padding-top: 7px;">
                     ...
                     <?php if($this->user_permissions->is_add('t_job_receive')){ ?><input type="button" id="btnSave" title='Save <F8>' /><?php } ?>
