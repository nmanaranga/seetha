                            ...
                            <?php
                                ...
                                for($x=0; $x<25; $x++){
                                    echo "<tr>";
                                        ...
                                        echo "<td><input type='text' class='g_input_txt g_col_fixed' id='m_".$x."' name='m_".$x."' style='width : 100%;'/></td>";
                                        ...
                                        <input type='text' class='g_input_num txt_align chk qun qtycl".$x." ky' id='3_".$x."' name='3_".$x."' style='width:76%;float: right;'/>
