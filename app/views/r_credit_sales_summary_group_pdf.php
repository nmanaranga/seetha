...
$this->pdf->Cell(0, 5, 'TOTAL CREDIT SALES SUMMARY GROUP',0,false, 'C', 0, '', 0, false, 'M', 'M');
...
if($value->nno == "")
{
	...
	$this->pdf->Cell(10, 6,"Sub No", '1', 0, 'C', 0);
	$this->pdf->Cell(15, 6,"Date", '1', 0, 'C', 0);
	$this->pdf->Cell(30, 6,"DO No", '1', 0, 'C', 0);
	$this->pdf->Cell(50, 6,"Customer", '1', 0, 'C', 0);
	$this->pdf->Cell(18, 6,"Gross Amount", '1', 0, 'C', 0);
	$this->pdf->Cell(15, 6,"Discount", '1', 0, 'C', 0);
	$this->pdf->Cell(18, 6,"Additional", '1', 0, 'C', 0);
	$this->pdf->Cell(18, 6,"Net Amount", '1', 0, 'C', 0);
	$this->pdf->Cell(18, 6,"Store", '1', 0, 'C', 0);
	...
	foreach ($purchase as $value) {
		...
		$aa = $this->pdf->getNumLines($value->cus_name, 50);
		...
		$this->pdf->MultiCell(10, $heigh,$value->sub_no, 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
		$this->pdf->MultiCell(15, $heigh,$value->ddate, 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
		$this->pdf->MultiCell(30, $heigh,$value->do_no, 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
		$this->pdf->MultiCell(50, $heigh,$value->cus_name, 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
		$this->pdf->MultiCell(18, $heigh,number_format($value->gross,2),  1, 'R', 0, 0, '', '', true, 0, false, true, 0);
		$this->pdf->MultiCell(15, $heigh,number_format((float)$value->discount+(float)$value->additional_deduct,2), 1, 'R', 0, 0, '', '', true, 0, false, true, 0);
		$this->pdf->MultiCell(18, $heigh,number_format($value->additional_add,2), 1, 'R', 0, 0, '', '', true, 0, false, true, 0);
		$this->pdf->MultiCell(18, $heigh,number_format($value->net_amount,2), 1, 'R', 0, 0, '', '', true, 0, false, true, 0);
		$this->pdf->MultiCell(18, $heigh,$value->description, 1, 'L', 0, 1, '', '', true, 0, false, true, 0);
	...
	if(!empty($cancel)){
		...
		$this->pdf->Cell(50, 6,"Total ", '0', 0, 'R', 0);
		$this->pdf->Cell(17, 6,number_format($c_gross,2), 'TB', 0, 'R', 0);
		$this->pdf->Cell(1, 6,"", '0', 0, 'R', 0);
		$this->pdf->Cell(17, 6,number_format((float)$c_dis,2), 'TB', 0, 'R', 0);
		$this->pdf->Cell(1, 6,"", '0', 0, 'R', 0);
		$this->pdf->Cell(18, 6,number_format((float)$c_add,2), 'TB', 0, 'R', 0);
		$this->pdf->Cell(18, 6,number_format($c_net,2), 'TB', 0, 'R', 0);
		$this->pdf->Cell(18, 6,"", '0', 0, 'R', 0);
