<?php if($this->user_permissions->is_view('g_internel_transfer')){ ?>
<link rel="stylesheet" type="text/css" href="<?=base_url()?>css/t_forms.css" />
<script type="text/javascript" src="<?=base_url()?>js/g_internel_transfer.js"></script>
...
<h2 style="text-align: center;">Gift Voucher Internal Transfer</h2>
<div class="dframe" id="mframe" style="padding-right:25px; width: 900px;">
    <form method="post" action="<?=base_url()?>index.php/main/save/g_internel_transfer" id="form_">
            ...
            <tr>
                <td colspan="2">
                    <fieldset>
                     ...
                     <input type="hidden" name="df_is_serial" id="df_is_serial" value="1" title="1"/>
             ...
             <td  rowspan='3'  valign="top" align="right">
                <table>
                    ...
                    <tr>
                        <td>No</td>
                        <td>
                            <input type="text" class="input_active_num" name="id" id="id" style="width:100%" title="<?=$id?>" readonly/>
                    ...
                    <tr><td>Date</td>
                        <td>
                            <?php if($this->user_permissions->is_back_date('g_internel_transfer')){ ?>
            ...
            <td colspan="2">
                <fieldset>
                    ...
                    <span style="padding-left:34px;">
                        <input type="text"  class="input_txt"  id="vehicle" name="vehicle"  title="" style="width: 150px;" readonly="readonly" /> 
   ...
   <!--                              <th class="tb_head_th" width="70">Code</th>
            ...
            <table>
                <tr >
                    ...
                    <td>
                        <textarea id="note" class="input_txt" style="width:485px;" name="note" cols="50" rows="2"></textarea>
                    </td>
            ...
            <div style="text-align: right; padding-top: 7px; margin-right:2px;">
                ...
                <?php if($this->user_permissions->is_delete('g_internel_transfer')){ ?><input type="button" id="btnDelete" title="Cancel" /><?php } ?>
                <?php if($this->user_permissions->is_re_print('g_internel_transfer')){ ?><input type="button" id="btnPrint" title="Print" /><?php } ?>
                <?php if($this->user_permissions->is_add('g_internel_transfer')){ ?><input type="button" title='Save <F8>' value="Save" id="btnSave" /><?php } ?>
                    <input type="button" title="Reject" value="REject" id="btnReject" />
                    <input type="hidden" name='save_chk' value="0" title="0" id="save_chk" > 
                    <?php 
                    if($this->user_permissions->is_print('g_internel_transfer')){ ?>
...
<form id="print_pdf" action="<?php echo site_url(); ?>/reports/generate" method="post" target="_blank">
    ...
    <input type="hidden" name='by' value='g_internel_transfer' title="g_internel_transfer" class="report">
    <input type="hidden" name='page' value='A4' title="A4" >
    <input type="hidden" name='orientation' value='P' title="P" >
    <input type="hidden" name='type' value='g_internel_transfer' title="g_internel_transfer" >         
