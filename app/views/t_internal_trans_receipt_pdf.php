<?php
		...
		foreach($session as $ses){
			...
			$this->pdf->Ln();
		 	...
		 	if($duplicate=="1"){
				$this->pdf->Cell(0, 5,'INTERNAL TRANSFER RECEIPT',0,false, 'C', 0, '', 0, false, 'M', 'M');
			}else{
				$this->pdf->Cell(0, 5,'INTERNAL TRANSFER RECEIPT (DUPLICATE)',0,false, 'C', 0, '', 0, false, 'M', 'M');
			}
		 	...
		 	$this->pdf->Cell(1, 1, $acc_name, '0', 0, 'L', 0);
		 	$this->pdf->Ln();
		 	$this->pdf->Cell(8, 1, "ID No ", '0', 0, 'L', 0);
		 	$this->pdf->Cell(1, 1, $acc_id, '0', 0, 'L', 0);
		 	$this->pdf->Ln();
		 	$this->pdf->Ln();
		 	...
		 	$this->pdf->Cell(1, 1,number_format($bal,2), '0', 0, 'R', 0);
		 	$this->pdf->Ln();
			...
			$this->pdf->Ln();
		 	...
		 	$this->pdf->Cell(80, 1, ' Checked By', '0', 0, 'L', 0);
	...
	$this->pdf->Output("Internal Transfer Receipt".date('Y-m-d').".pdf", 'I');
