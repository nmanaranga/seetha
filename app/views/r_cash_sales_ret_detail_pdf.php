...
error_reporting(E_ALL ^ E_NOTICE ^ E_WARNING);
		...
		$this->pdf->setY(23);
        	...
        	$this->pdf->SetFont('helvetica', 'BU',10);
		 	$this->pdf->Cell(0, 5, 'CASH SALES RETURN DETAILS',0,false, 'C', 0, '', 0, false, 'M', 'M');
			$this->pdf->Ln();
			$this->pdf->Ln();
           ...
           else
           {
			...
			$this->pdf->Ln();
				//$this->pdf->SetY(45);
					  ...
					  $this->pdf->Cell(19, 6, number_format($tot_price,2), 'TB', 0, 'R', 0);
					  ...
					  $this->pdf->Cell(1, 6,"", '0', 0, 'R', 0);
					  $this->pdf->Cell(20, 6, number_format($net[$a],2), 'TB', 0, 'R', 0);
