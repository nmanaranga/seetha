<?php
   ...
   $this->pdf->setPrintHeader(true,$type);
    $this->pdf->setPrintFooter(true);
        ...
        foreach($scat as $sc){
         ...
         foreach($sup as $su){
            ...
            $this->pdf->Cell(30, 1,": ".$br_code." - ".$br_name, '0', 0, 'L', 0);
        ...
        foreach($item_det as $row){
                ...
                $this->pdf->MultiCell(20, $heigh, $row->min_price,  1, 'R', 0, 0, '', '', true, 0, false, true, 0);
                $this->pdf->MultiCell(25, $heigh, $row->max_price,  1, 'R', 0, 0, '', '', true, 0, false, true, 0);
                $this->pdf->MultiCell(20, $heigh, number_format($cost,2),  1, 'R', 0, 1, '', '', true, 0, false, true, 0);
    ...
    $this->pdf->Cell(20, 1, number_format($tot_cost,2), 'TB', 0, 'L', 0);
