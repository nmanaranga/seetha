...
$this->pdf->Cell(180, 1,"Monthly Sales target Supervisor Wise  ",0,false, 'L', 0, '', 0, false, 'M', 'M');

$this->pdf->Ln();
$this->pdf->setY(27);
$this->pdf->Cell(80, 1,"",'T',0, 'L', 0);
$this->pdf->Ln();
$this->pdf->Ln();
...
$this->pdf->Cell(80, 1,": ".$emplo, '0', 0, 'L', 0);
...
$this->pdf->MultiCell(18, $heigh, "Achi. %",  1, 'L', 0, 0, '', '', true, 0, false, true, 0);
...
foreach($salesTrget as $row){
    ...
    $this->pdf->MultiCell(18, $heigh, number_format($pre,2)."%"          ,  1, 'R', 0, 0, '', '', true, 0, false, true, 0);
