...
$this->pdf->Cell(180, 1,"Monthly Sales target   ",0,false, 'L', 0, '', 0, false, 'M', 'M');

$this->pdf->Ln();
$this->pdf->setY(27);$this->pdf->Cell(45, 1,"",'T',0, 'L', 0);
$this->pdf->Ln();
$this->pdf->Ln();
...
$this->pdf->setX(5);
$this->pdf->MultiCell(25, $heigh, "Day" ,  1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$this->pdf->MultiCell(25, $heigh, "Target",  1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$this->pdf->MultiCell(30, $heigh, "Achivement",  1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$this->pdf->MultiCell(15, $heigh, "A. %",  1, 'L', 0, 0, '', '', true, 0, false, true, 0);
...
$this->pdf->MultiCell(90, $heigh, "Reason",  1, 'L', 0, 0, '', '', true, 0, false, true, 0);
$this->pdf->Ln();
...
foreach($salesTrget as $row){
    ...
    $varAmount=number_format(((float)$row->achivement) - ((float) $row->target),2);
    $varAmountPres= ( (float)$row->achivement - (float)$row->target ) / (float)$row->achivement  * 100;


    $this->pdf->MultiCell(25, $heigh, $row->dday ."- ".date('D', $yrdata) ,  1, 'L', 0, 0, '', '', true, 0, false, true, 0);
    $this->pdf->MultiCell(25, $heigh, number_format($row->target,2),  1, 'R', 0, 0, '', '', true, 0, false, true, 0);
    $this->pdf->MultiCell(30, $heigh, number_format($row->achivement,2)  ,  1, 'R', 0, 0, '', '', true, 0, false, true, 0);
    ...
    $this->pdf->MultiCell(15, $heigh, number_format($varAmountPres,2)."%"   ,  1, 'R', 0, 0, '', '', true, 0, false, true, 0);
    $this->pdf->MultiCell(90, $heigh, $row->reason,  1, 'L', 0, 0, '', '', true, 0, false, true, 0);
...
$this->pdf->Cell(35, 6, " Total Target", '0', 0, 'L', 0);
$this->pdf->Cell(5, 6, " : ", '0', 0, 'L', 0);
$this->pdf->Cell(30, 6, number_format($target,2), 'TB', 0, 'R', 0);
$this->pdf->Ln();
$this->pdf->Cell(35, 6, " Total Archivement", '0', 0, 'L', 0);
$this->pdf->Cell(5, 6, " : ", '0', 0, 'L', 0);
$this->pdf->Cell(30, 6, number_format($archment,2), 'TB', 0, 'R', 0);
$this->pdf->Cell(2, 6, "  ", '0', 0, 'L', 0);
$this->pdf->Cell(30, 6, number_format($archmentPre,2)."%", 'TB', 0, 'R', 0);
$this->pdf->Ln();
$this->pdf->Cell(35, 6, " Variance", '0', 0, 'L', 0);
$this->pdf->Cell(5, 6, " : ", '0', 0, 'L', 0);
$this->pdf->Cell(30, 6, number_format($target-$archment,2) ,'TB', 0, 'R', 0);
