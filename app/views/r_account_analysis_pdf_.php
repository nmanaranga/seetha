...
$this->pdf->Cell(25, 4, "Op Acc Code", '1', 0, 'C', 0);
$this->pdf->Cell(60, 4, "Op Account", '1', 0, 'C', 0);
...
foreach($all_acc_det as $row){
	...
	$heigh=6*(max(1,$this->pdf->getNumLines($row->description, 55),$this->pdf->getNumLines($row->op_ac, 60)));
	...
	$this->pdf->MultiCell(60, $heigh,  $row->op_ac, 1, 'L', 0, 0, '', '', true, 0, false, true, 0);
