...
$this->pdf->Ln();
$this->pdf->Cell(0, 5, ' Open Stock Report', 0, false, 'C', 0, '', 0, false, '0', '0');
...
$this->pdf->Cell(75, 6,$row->description, '1', 0, 'L', 0);
$this->pdf->Cell(25, 6,$row->model, '1', 0, 'C', 0);
$this->pdf->Cell(15, 6,$row->qty, '1', 0, 'C', 0);
$this->pdf->Cell(20, 6,number_format($row->cost,2), '1', 0, 'R', 0);
