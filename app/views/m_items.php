...
<script type='text/javascript' src='<?=base_url()?>js/m_items.js? <?=rand();?>'></script>


<h2>Items</h2>
    <table border="0">
        <tr>
            <td valign="top"  class="content"  style="width: 550px;">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size: 12px;">
						...
						<tr>
							...
							<td colspan="2">
								...
								<input type="hidden" id="is_gift" name="is_gift" value="0" title="0">
							</td>
						</tr>
                        ...
                        <tr>
                            <td>Code</td>                            
                            <td colspan="3"><input type="text" class="input_active"  id="code" name="code" maxlength="14"  style="width:180px; text-transform:uppercase;"> <input type="hidden" id="code_" name="code_" />
                            	<input type='button' id='item_gen' title='Generate' value='Generate'/>
                            	<input type="text" class="input_active"  id="last_code" name="last_code" maxlength="14"  style="width:140px; text-transform:uppercase;"> 
                            </td>
                        </tr>
                        ...
                        <tr>
						<td colspan="5" align="center"><input type="checkbox" name="inactive" id="inactive" title="1" /> Inactive
						<input type="checkbox" name="serial_no" id="serial_no" title="1" />Serial Number Item
						<input type="checkbox" name="batch_item" id="batch_item" title="1"  checked="true" />Batch Item
                    ...
                    <div id="tabs-1">
								...
								<table border="0" cellpadding="0">
											...
											<tr>
												...
												<td colspan="3" ><input type="text" class="input_txt"   id="brand_des"  style="width: 277px;" readonly="readonly">
												<input type="button" title="..." id="btn_brand" name="btn_brand"/></td>
											</tr>
											...
											<tr>
													<td>Warranty</td>
													<td><input type="text" class="input_txt g_input_num"  id="warranty" name="warranty" style="width: 150px;"></td>
													<td style="width:50px;"></td>
			...
			<fieldset>
					...
					<table border="0" cellpadding="0">
							...
							<tr>
								...
								<td><input type"text" name="modified_date" class="hid_value" id="modified_date" style="width: 150px;" maxlength="12" readonly/></td>
								<td>Tax Rate  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;%</td>
								<td>
									<input type='text' class="input_txt g_col_fixed" name='tax_rate_pre' id='tax_rate_pre' style="width: 75px;text-align:right;"/>
		...
		<table style="width:100%;" cellpadding="0" id="tgrid">
				<thead>
                            <tr>
