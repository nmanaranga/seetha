...
foreach($session as $ses){
    $invoice_no=$session[0].$session[1]."JE".$session[2];
}
...
$this->pdf->Ln();
if($duplicate=="1"){
    $this->pdf->Cell(0, 5,' JOURNAL ENTRY',0,false, 'C', 0, '', 0, false, 'M', 'M');
}else{
    $this->pdf->Cell(0, 5,' JOURNAL ENTRY (DUPLICATE)',0,false, 'C', 0, '', 0, false, 'M', 'M');
}
...
foreach ($otherdtl as $value) {
    ...
    $this->pdf->Cell(40, 1, $value->cluster_name, '0', 0, 'L', 0);
}
foreach ($otherdtl as $value) {
...
foreach ($otherdtl as $value) {
    ...
    $this->pdf->Cell(40, 1, $value->branch_name, '0', 0, 'L', 0);
}
foreach ($otherdtl as $value) {
...
foreach ($otherdtl as $value) {
    ...
    $this->pdf->Cell(5, 1, '', '0', 0, 'L', 0);
    $this->pdf->Cell(40, 1, $value->des, '0', 0, 'L', 0);
    $this->pdf->Cell(30, 1, "", '0', 0, 'L', 0);
}
foreach ($otherdtl as $value) {
...
$this->pdf->Cell(70, 8, "Discription", '1', 0, 'L', 0);
$this->pdf->Cell(30, 8, "Memo", '1', 0, 'L', 0);
...
$this->pdf->SetX(105);
$this->pdf->Cell(20, 5, "", '0', 0, 'c', 0);
$this->pdf->Ln();
$this->pdf->SetX(105);
$this->pdf->Cell(40, 5, 'Total', '0', 0, 'C', 0);

$this->pdf->Cell(20, 5, number_format($totdr, 2), '1', 0, 'C', 0);

$this->pdf->Cell(20, 5, number_format($totcr, 2), '1', 0, 'C', 0);
