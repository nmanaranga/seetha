...
foreach($session as $ses){
	...
	if($trns_mode==0){
		$mode_no=$session[0].$session[1]."ITP".$session[3];
	}else if($trns_mode=='1'){
		$mode_no=$session[0].$session[1]."DTR".$session[3];
	}else{
		$mode_no=$session[0].$session[1]."RTR".$session[3];
	}
}
...
if($orgin_print=="1"){
	if($trns_mode=='0'){
		...
		$this->pdf->Cell(0, 5, $r_type.' DIRECT TRANSFER RECEIVE',0,false, 'C', 0, '', 0, false, 'M', 'M');
	}else{
		$this->pdf->Cell(0, 5, $r_type.' RETURN TRANSFER RECEIVE',0,false, 'C', 0, '', 0, false, 'M', 'M');
	}
}else{
	if($trns_mode=='0'){
		$this->pdf->Cell(0, 5, $r_type.' INTERNAL TRANSFER RECEIVE (Duplicate)',0,false, 'C', 0, '', 0, false, 'M', 'M');
	}else if($trns_mode=='1'){
		$this->pdf->Cell(0, 5, $r_type.' DIRECT TRANSFER RECEIVE (Duplicate)',0,false, 'C', 0, '', 0, false, 'M', 'M');
	}else{
		$this->pdf->Cell(0, 5, $r_type.' RETURN TRANSFER RECEIVE',0,false, 'C', 0, '', 0, false, 'M', 'M');
	}
...
$this->pdf->Cell(20, 1, $mode_no, '0', 0, 'L', 0);
...
$this->pdf->Cell(30, 1, 'Sub No', '0', 0, 'L', 0);
$this->pdf->Cell(20, 1, $subNo, '0', 0, 'L', 0);

/*$this->pdf->Ln();
$this->pdf->Cell(30, 1, 'Mode no', '0', 0, 'L', 0);
$this->pdf->Cell(20, 1, $mode_no, '0', 0, 'L', 0);
*/
...
$this->pdf->SetX(2);
$this->pdf->SetFont('helvetica','B',8);
$this->pdf->Cell(10, 9,"No", '1', 0, 'C', 0);
$this->pdf->Cell(30, 9,"Item Code", '1', 0, 'C', 0);
$this->pdf->Cell(40, 9,"Item Description", '1', 0, 'C', 0);
$this->pdf->Cell(20, 9,"Model", '1', 0, 'C', 0);
$this->pdf->Cell(10, 9,"QTY", '1', 0, 'C', 0);
$this->pdf->Cell(18, 9,"Unit Price", '1', 0, 'C', 0);
$this->pdf->Cell(18, 9,"Last Price", '1', 0, 'C', 0);
...
//
	...
	$this->pdf->Setx(2);
	$this->pdf->MultiCell(10, $heigh,$x, '1', 'C', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
	...
	$this->pdf->MultiCell(18, $heigh,number_format($row->item_cost,2), '1',  'R', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
	$this->pdf->MultiCell(18, $heigh,number_format($row->min_price,2), '1',  'R', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
	$this->pdf->MultiCell(20, $heigh,number_format($row->max_price,2), '1',  'R', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
	$this->pdf->MultiCell(10, $heigh,number_format($lpm,2), '1',  'R', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
	$this->pdf->MultiCell(10, $heigh,number_format($spm,2), '1',  'R', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
	...
	if($all_serial!="")
	{
		...
		$this->pdf->MultiCell(10, $heigh,"", '1',  'C', false, 0, '', '', true, 0, false, true, $heigh,'M' ,true);
		$this->pdf->MultiCell(18, $heigh,"", '1',  'R', false, 0, '', '', true, 0, false, true, $heigh,'M' ,true);
		$this->pdf->MultiCell(18, $heigh,"", '1',  'R', false, 0, '', '', true, 0, false, true, $heigh,'M' ,true);
...
$this->pdf->Setx(2);
$this->pdf->MultiCell(10, $heigh,'', '0', 'C', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
$this->pdf->MultiCell(30, $heigh,'', '0', 'L', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
$this->pdf->MultiCell(40, $heigh,'', '0', 'L', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
$this->pdf->MultiCell(20, $heigh,'Total', '0', 'L', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
$this->pdf->MultiCell(10, $heigh,$totQty, 'TB',  'C', false, 0, '', '', true, 0, false, true, $heigh,'M' ,false);
