    ...
    <form method="post" action="<?=base_url()?>index.php/main/save/t_dispatch_unloading" id="form_">
        <table style="width: 100%" border="0">
            ...
            <tr>
                ...
                <td style="width: 100px;">Loading No</td>
                <td style="width: 100px;"><input type="text" class="input_txt" name="load_no" id="load_no" title="" style="width: 100%; text-align:right;" maxlength="25"/></td>
                            ...
                            <?php
                                ...
                                for($x=0; $x<25; $x++){
                                    echo "<tr>";
                                        ...
                                        echo "<td><input type='text' class='g_input_txt' id='m_".$x."' name='m_".$x."' style='width : 100%;'/></td>";
                                        ...
                                        echo "<td><input type='text' class='g_input_amo g_col_fixed' id='min_".$x."' name='min_".$x."' style='width : 100%;'/></td>";
                                        echo "<td><input type='text' class='g_input_amo g_col_fixed' id='max_".$x."' name='max_".$x."' style='width : 100%;'/></td>";


                                        echo "<td><input type='button'  class='quns' id='btn_".$x."' style='margin:0;padding:5px;float: left; height:6px;width:6px;cursor:pointer'/>
                                        <input type='text' class='g_input_num txt_align chk qun qtycl".$x." ky' id='3_".$x."' name='3_".$x."' style='float:right;width:40px;'/>
                                        <input type='hidden' class='g_input_amo dis' id='qtyh_".$x."' name='qtyh_".$x."' /></td>";
                                        echo "<td><input type='text' class='g_amount g_input_amo' id='amount_".$x."' name='amount_".$x."' />
