...
$this->pdf->SetFont('helvetica', 'B', 16);
		...
		if(!empty($bank_entry)){
			...
			$this->pdf->Cell(80, 1, 'Bank A/C No', '0', 0, 'L', 0);
		...
		foreach($bank_entry as $b){
			...
			$this->pdf->Cell(80, 1, $b->bank_acc, '0', 0, 'L', 0);
		...
		$this->pdf->Cell(20, 1, number_format((float)$rcp,2), '0', 0, 'R', 0);
		...
		$this->pdf->Cell(20, 1,  number_format((float)$rcp+(float)$rcp_transport+(float)$rcp_advance+(float)$rcp_other,2), '0', 0, 'R', 0);
		...
		$this->pdf->Cell(20, 1,  number_format((float)$cash_s+(float)$cash_m+(float)$rcp+(float)$rcp_transport+(float)$rcp_advance+(float)$rcp_other,2), 'TB', 0, 'R', 0);
		...
		$this->pdf->Ln();
		$this->pdf->HaveMorePages(6);
		 	//$ct=(float)$cash_s+(float)$cash_m+(float)$rcp+(float)$rcp_card+(float)$rcp_cheque+(float)$rcp_transport+(float)$rcp_advance+(float)$rcp_other;
		$ct=(float)$cash_s+(float)$cash_m+(float)$rcp+(float)$rcp_transport+(float)$rcp_advance+(float)$rcp_other+(float)$opb;
		$rt=(float)$rcp_cancel+(float)$cash_voucher+(float)$cash_manual+(float)$entry_tot;
		...
		$this->pdf->Cell(20, 1, '', '0', 0, 'L', 0);
		$this->pdf->Cell(10, 1, ' 	Coins', '0', 0, 'R', 0);
		...
		$this->pdf->Cell(20, 1, '', '0', 0, 'L', 0);
		$this->pdf->Cell(10, 1, 'Execess/Shotage', '0', 0, 'L', 0);
		$this->pdf->Cell(25, 1, '', '0', 0, 'L', 0);
		$this->pdf->Cell(40, 1, '', '0', 0, 'R', 0);
		$this->pdf->Cell(65, 1, '', '0', 0, 'C', 0);
		$this->pdf->Cell(20, 1, number_format($shortage,2), 'B', 0, 'R', 0);
		...
		$this->pdf->Cell(20, 1, '', '0', 0, 'L', 0);
		$this->pdf->Cell(50, 1, ' 	Credit Card Sales', '0', 0, 'L', 0);
		$this->pdf->Cell(30, 1, '', '0', 0, 'L', 0);
		$this->pdf->Cell(20, 1, number_format($i_cccard,2), '0', 0, 'R', 0);
		...
		$this->pdf->Cell(90, 1, '', '0', 0, 'L', 0);
		$this->pdf->Cell(20, 1, number_format(((float)$i_cash+(float)$i_credit+(float)$i_cccard)-(float)$i_return,2), 'TB', 0, 'R', 0);
		...
		$this->pdf->Cell(160, 1, $note, '0', 0, 'L', 0);
		...
		$this->pdf->Ln();
		$this->pdf->Cell(20, 1, '', '0', 0, 'L', 0);
		$this->pdf->Cell(20, 1, 'Prepared By', '0', 0, 'C', 0);
		$this->pdf->Cell(50, 1, '', '0', 0, 'L', 0);
		$this->pdf->Cell(20, 1, 'Checked By', '0', 0, 'C', 0);
		$this->pdf->Cell(40, 1, '', '0', 0, 'L', 0);
		$this->pdf->Cell(20, 1, 'Checked By', '0', 0, 'C', 0);
		$this->pdf->Ln();
		$this->pdf->Cell(20, 1, '', '0', 0, 'L', 0);
		$this->pdf->Cell(20, 1, '[Operation Assistant]', '0', 0, 'C', 0);
		$this->pdf->Cell(50, 1, '', '0', 0, 'L', 0);
		$this->pdf->Cell(20, 1, '[Branch Manager]', '0', 0, 'C', 0);
		$this->pdf->Cell(40, 1, '', '0', 0, 'L', 0);
		$this->pdf->Cell(20, 1, '[Accounts Department]', '0', 0, 'C', 0);
