    	...
    	<input type="hidden" name="df_is_serial" id="df_is_serial" value="<?php echo $ds['use_serial_no_items'] ?>" title="<?php echo $ds['use_serial_no_items'] ?>"/>
         ...
         <table style="width: 100%" border="0" cellpadding="0">
            <tr>
                ...
                Print Serial Numbers <input type="checkbox" id='prnt_srl'>
                </td>
                <td width="50">&nbsp;</td>    
                <td >No</td>
                <td align="right" >
                            ...
                            <tr>
                                ...
                                for($x=0; $x<25; $x++){
                                    echo "<tr>";
                                        ...
                                        <input type='text' class='g_input_num qty qun qtt_".$x." clr_".$x."' id='2_".$x."' name='2_".$x."' style='width : 30px; float:right;' style='width:100%;'/></td>";
                                        echo "<td style=''><input type='text' class='g_input_num foc' id='3_".$x."' name='3_".$x."' style='width : 100%;'/></td>";
