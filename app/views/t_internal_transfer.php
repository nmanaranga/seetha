...
<div class="dframe" id="mframe" style="padding-right:25px; width: 1000px;">
        ...
        <table style="width: 100%" border="0">
             ...
             <td  rowspan='3'  valign="top" align="right">
                <table>
                    <tr>
                        <td>No</td>
                        <td>  
                            <input type="text" class="hid_value" name="id" id="id" style="width:100%;text-align: right;" title="<?=$id?>" />
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="hidden" id="types" name="types" title="branch" />
                    ...
                    <tr>
                        <td>Mode</td>
                        <td>
                            <select style="width: 100%;" id="mode" name="mode">
                                <option value="0">Internal Transfer</option>
                                <option value="1">Direct Transfer</option>
                                <option value="2">Return</option>
                            </select>
                            <input type="hidden" name="tr_mode" id="tr_mode">
                        </td>
                    </tr>
                    <tr>
                        <td>Mode No</td>
                        <td><input id="mode_hid" type="hidden" title="0" name="mode_hid" value="0">
                            <input type="text" class="input_txt" name="mode_no" id="mode_no" title="" style="width: 100%; text-align:right;"/></td>
                        </tr>
                        <tr>
                            <td>DRN No</td>
                            <td><input type="text" class="input_active_num" id="drn_no" name="drn_no" readonly="readonly" style="width:100%" title="<?php echo $drn_no;?>"/></td>
                        </tr>
                ...
                <td colspan="2">
                    <fieldset>
                        ...
                        <span style="padding-left:34px;">
                            <input type="text"  class="input_txt"  id="vehicle" name="vehicle" readonly title="" style="width: 150px;" /> 
            ...
            <tr>
                <td style="padding-left:11px"><span>Order No</span>
                    <input type="text" name="order_no" id="order_no" class="input_active g_input_num" style="width:150px; margin-left:24px;">
                </td>
                <?php if($this->user_permissions->is_approve('t_internal_transfer')){ ?>
                <td><span>Original Print</span>
                    <input type="checkbox" name="oprint" id="oprint">
                </td>
                <?php } ?>
            </tr>
   ...
   <!--                              <th class="tb_head_th" width="70">Code</th>
                            ...
                            <th class="tb_head_th" style="width:60px;">Branch Stock</th>                           
                    ...
                    <tbody>
                       ...
                       for($x=0; $x<25; $x++){
                        ...
                        <input type='text' class='g_input_txt fo' id='0_".$x."' name='0_".$x."' style='pointer-events:none;' /></td>
                        ...
                        echo "<td style='background-color: #f9f9ec;'><input type='text' readonly='readonly' class='g_input_txt'  id='bcur_".$x."' name='bcur_".$x."' maxlength='150' style='width:100%; background-color: #f9f9ec; text-align:right;'/></td>";
            ...
            <div style="text-align: right; padding-top: 7px; margin-right:2px;">
                ...
                <?php if($this->user_permissions->is_add('t_internal_transfer')){ ?><input type="button" title='Save <F8>' value="Save" id="btnSave" /><?php } ?>
                    <?php if($this->user_permissions->is_approve('t_internal_transfer')){ ?><input type="button" title='Approve' value="Approve" id="btnApprove" /><?php } ?>
                    ...
                    <input type="hidden" id="appr_st" name="appr_st" title="0" />
