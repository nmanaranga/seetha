<?php if($this->user_permissions->is_view('t_branch_settlement')){ ?>
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>css/t_forms.css" />
    <script type="text/javascript" src="<?=base_url()?>js/t_branch_settlement.js"></script>


    <h2 style="text-align: center;">Branch Settlement</h2>
    <div class="dframe" id="mframe">
        <form method="post" action="<?=base_url()?>index.php/main/save/t_branch_settlement" id="form_">
            ...
            <tr>
               <td style="width: 100px;">No Range</td>
               <td>
                <input type="text" id="no_1" name="no_1" class="input_active g_input_num" title=""/>
                <input type="text" id="no_2" name="no_2" class="input_active g_input_num" title=""/>
                <input type="button" id='load' Title='Load'>
            </td>
            <td style="width: 100px;">Date</td>
            <td style="width: 100px;">
                <?php if($this->user_permissions->is_back_date('t_branch_settlement')){ ?>
                ...
                <table style="width: 875px;" id="tgrid2">
                    <thead>
                        <tr>
                            <th class="tb_head_th" style="width: 80px;">Type</th>
                            <th class="tb_head_th" style="width: 80px;">No</th>
                            <th class="tb_head_th" style="width: 80px;">Sub No</th>
                            <th class="tb_head_th" style="width: 80px;">Date</th>
                            <th class="tb_head_th" style="width: 80px;">Amount</th>
                            <th class="tb_head_th" style="width: 80px;">Balance</th> 
                            <th class="tb_head_th" style="width: 80px;">Settle</th>
                        ...
                        for($x=0; $x<100; $x++){
                            ...
                            echo "<td><input type='text' class='g_input_txt g_col_fixed'        id='sn_".$x."' name='sn_".$x."'  style='width:100%;background-color: #f9f9ec;' maxlength='150'/></td>";
        ...
        <tr>
            <td colspan="4">
                <div style="text-align: left; padding-top: 7px;">
                    ...
                    <?php if($this->user_permissions->is_delete('t_branch_settlement')){ ?><input type="button" id="btnDelete" title="Cancel" /><?php } ?>
                    <?php if($this->user_permissions->is_re_print('t_branch_settlement')){ ?><input type="button" id="btnPrint" title="Print" /><?php } ?>

                    <?php if($this->user_permissions->is_add('t_branch_settlement')){ ?><input type="button" id="btnSave" title='Save <F8>' /><?php } ?>             
                </div>
...
<form id="print_pdf" action="<?php echo site_url(); ?>/reports/generate" method="post" target="_blank">
  <input type="hidden" name='by' value='t_branch_settlement' title="t_branch_settlement" class="report">
