<?php if($this->user_permissions->is_view('g_internel_transfer_order')){ ?>
<link rel="stylesheet" type="text/css" href="<?=base_url()?>css/t_forms.css" />
<script type="text/javascript" src="<?=base_url()?>js/g_internel_transfer_order.js"></script>


<h2 style="text-align: center;">Gift Voucher Internal Transfer Order</h2>
<div class="dframe" id="mframe" style="width: 980px;">
    <form method="post" action="<?=base_url()?>index.php/main/save/g_internel_transfer_order" id="form_">
        <table style="width: 100%" border="0">
            <tr>
                ...
                <td style="width: 100px;">
                    ...
                    <?php if($this->user_permissions->is_back_date('g_internel_transfer_order')){ ?>
            ...
            <tr>
                <td style="width: 100px;">Request Branch</td>
                <td>
          ...
          <tr>
                <td colspan="4" style="text-align: center;">
                    ...
                    <div style="text-align: left; padding-top: 7px;">
                        ...
                        <?php if($this->user_permissions->is_delete('g_internel_transfer_order')){ ?><input type="button" id="btnDelete" title="Delete" /><?php } ?>
                        <?php if($this->user_permissions->is_re_print('g_internel_transfer_order')){ ?><input type="button" id="btnPrint" title="Print" /><?php } ?>                     
                        <?php if($this->user_permissions->is_add('g_internel_transfer_order')){ ?><input type="button"  id="btnSave" title='Save <F8>' /><?php } ?>
                    </div>
                </td>
            </tr>
        </table>
        <?php 
        if($this->user_permissions->is_print('g_internel_transfer_order')){ ?>
     ...
     <form id="print_pdf" action="<?php echo site_url(); ?>/reports/generate" method="post" target="_blank">
                 ...
                 <input type="hidden" name='by' value='g_internel_transfer_order' title="g_internel_transfer_order" class="report">
                 <input type="hidden" name='page' value='A4' title="A4" >
                 <input type="hidden" name='orientation' value='P' title="P" >
                 <input type="hidden" name='type' value='g_internel_transfer_order' title="g_internel_transfer_order" >
