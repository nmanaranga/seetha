...
foreach($cash_sum as $csum){
	...
	$pay_gift=$csum->pay_gift_voucher;
	$ref_no = $csum->ref_no;
	$memo = $csum->memo;
}
...
$this->pdf->footer_set_cash_sales($employee,$amount,$additional,$discount,$user,$credit_card,$tot_free_item,$cheque_detail,$credit_card_sum,$other1,$other2,$additional_tot,$pay_gift,$memo);
