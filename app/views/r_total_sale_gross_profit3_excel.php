...
$this->excel->getActiveSheet()->setCellValue('L'.$r,"Cost");
...
foreach($r_data as $row){
	...
	$this->excel->getActiveSheet()->setCellValue('L'.$key, $row->cost);   
...
$this->excel->getActiveSheet()->setCellValue('K'.$r2, "Additonal");
$this->excel->getActiveSheet()->setCellValue('L'.$r2, $tot_additonal); 
...
$this->excel->getActiveSheet()->setCellValue('H'.$r2, $c_gross);
$this->excel->getActiveSheet()->setCellValue('I'.$r2, $c_dis);
$this->excel->getActiveSheet()->setCellValue('J'.$r2, $c_net);  
$this->excel->getActiveSheet()->setCellValue('K'.$r2, $c_ret);
$this->excel->getActiveSheet()->setCellValue('L'.$r2, $c_cost); 
$this->excel->getActiveSheet()->setCellValue('M'.$r2, "");
