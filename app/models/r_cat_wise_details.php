...
class r_cat_wise_details extends CI_Model{
  ...
  public function PDF_report($RepTyp=""){
    ...
    $sql="SELECT s.*,i.`description`,i.model,i.`category`,sc.`description` AS cat_name,e.`name` FROM 
    ...
    $sql.=" ORDER BY s.rep,ddate,type,nno,sc.`code`";
