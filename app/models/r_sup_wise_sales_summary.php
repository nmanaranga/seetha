...
class r_sup_wise_sales_summary extends CI_Model{
  ...
  public function PDF_report($RepTyp=""){
    ...
    $r_detail['supplier_des']=$_POST['supplier_des'];
    ...
    JOIN `m_supplier` su ON su.`code`=i.`supplier`
    ...
    if($_POST['supplier']!=""){
      $sql.=" AND i.`supplier`='".$_POST['supplier']."'";
    }

    $sql.=" GROUP BY i.`supplier` ";
