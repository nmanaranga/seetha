...
public function PDF_report(){
  ...
  $sql="SELECT d.code, m.`description`,m.`model`,d.qty,d.`max` as max_price, d.min, d.batch_no
  ...
  $sql="SELECT s.* , s1.`description` AS tstore_des, s2.`description` AS fstore_des, 
  e.`name` AS e_name FROM t_dispatch_sum s
