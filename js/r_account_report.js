...
$(document).ready(function() {
	...
	$("#acc_analysis").click(function(){
		$("#by").val("r_account_analysis");
		$("#acc_table").css("display","block");
		$("#account_c").css("display","block");
		$("#trans_type").css("display","none");
		$("#status").css("display","none");
	...
	$("#acc_det_old").click(function(){
		$("#by").val("r_account_report_last_yer");
		$("#acc_table").css("display","block");
		$("#account_c").css("display","block");
		$("#trans_type").css("display","none");
		$("#status").css("display","none");
	...
	$("#trial_balance_for_pe").click(function(){
		$("#by").val("r_trail_bal_for_pe");
		$("#type").val("r_trail_bal_for_pe");
		$("#acc_table").css("display","none");
		$("#trans_type").css("display","none");
		$("#account_c").css("display","none");
		$("#status").css("display","none");
...
$("#jurnal_entry").click(function(){
 ...
 $("#dep_sales_grn_report").click(function(){
		$("#by").val("r_dep_sg_report");// model name
		$("#type").val("r_dep_sg_report"); //tc pdf file name
		$("#acc_table").css("display","none");
		$("#trans_type").css("display","none");
		$("#account_c").css("display","none");
		$("#status").css("display","none");
 ...
 $("#acc_code,#t_type").keydown(function(e){
 	var id = $(this).attr("id");
 	if(e.keyCode==46){
 		$("#"+id+"_des").val("");
 		$("#"+id).val("");
