...
function check_code(){
  ...
  $.post("index.php/main/load_data/t_loyalty_card_issue/check_code", {
    card_no : card_no
  }, function(res){
    if(res != 2){
...
function load_data9(){
  $.post("index.php/main/load_data/t_loyalty_card_issue/customer_list", {
...
function settings9(){
  $("#item_list .cl").click(function(){        
    ...
    check_issue_card($(this).children().eq(0).html());
...
function check_issue_card(code){
  $.post("index.php/main/load_data/t_loyalty_card_issue/check_issue_card", {
    code:code
  }, function(r){
    if(r==1){
      alert("This Customer Already Loyalty Card Member");
      $("#customer_id").val("");
      $("#customer_des").val("");
      $("#address").val("");
      $("#tp").val("");
