...
$(document).ready(function(){
  ...
  $("#load_no").keydown(function(e){
    if(e.keyCode==13){
      if($("#from_store").val()!="0"){
        load_loading_details();
      }else{
...
function load_loading_details(){
  empty_grid();
  $.post("index.php/main/load_data/t_dispatch_unloading/loading_details", {
    id: $("#load_no").val(),
    store:$("#from_store").val()
  }, function(r){
    if(r=="2"){
...
$("#pop_search").keyup(function(e){
  if(e.keyCode != 13 && e.keyCode != 38 && e.keyCode != 40 && e.keyCode != 112 ) { load_items();}
});
